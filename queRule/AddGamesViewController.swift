...
class AddGamesViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(keyboardWillShow), name:
            Notification.Name.UIKeyboardWillShow, object: nil)
        ...
        txtBorrowedTo.inputView = datePicker
        ...
        if game == nil {
            ...
            borrowedSwitch.isOn = false
                ...
                if let txtBorrowedDate = game?.borrowedDate as? Date {
                    self.txtBorrowedDate.text = dateFormatter.string(from: txtBorrowedDate)
                }
    ...
    func takePictureTapped() {
        ...
        guard cameraPermissions else {
            let permissionsAlertController = UIAlertController(title: "Permisos", message: "No tiene permiso para acceder a la cámara del dispositivo. Puede cambiar esta información en la app de Ajustes de iOS", preferredStyle: .alert)
    ...
    @IBAction func deletePressed() {
        ...
        if let context = self.managedObjectContext {
            ...
            game = nil
            delegate?.didAddGame() 
            // Volvemos atrás una vez borrado.
